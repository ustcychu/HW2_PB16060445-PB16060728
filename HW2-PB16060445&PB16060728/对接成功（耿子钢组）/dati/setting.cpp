...
int ques_num=5, oper_max=10, oper_num=5, prec=2, flag_1=0, decimal=0, real=0;
...
void Setting::on_pushButton_clicked()
{
    ...
    switch(select)
    {
        case 0: {decimal=0;real=0; break;}
        case 1: {decimal=1;real=1; break;}
        case 2: {decimal=1;real=0; break;}
        default: {decimal=0;real=0; break;}
    }

    if( ques_num<1 || ques_num>1000 )  ques_num=5;
    if( oper_max<1 || oper_max>500 )  oper_max=10;
