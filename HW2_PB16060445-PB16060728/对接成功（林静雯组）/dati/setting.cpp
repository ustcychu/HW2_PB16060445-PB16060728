...
int ques_num=5, oper_max=100, oper_num=10, oper_kind=0, prec=1;
...
void Setting::on_pushButton_clicked()
{
    ...
    switch(select)
    {
        case 0: oper_kind=1; break;
        case 1: oper_kind=0; doub=1; break;
        case 2: oper_kind=2; frac=1; break;
        default: oper_kind=1;
    }
    ...
    if( prec<0 || prec>3 )  prec=1;

    if(ui->checkBox_2->isChecked()) oper_kind=1;

    if(ui->checkBox_3->isChecked()) oper_kind=2;

    if(ui->checkBox_4->isChecked()) oper_kind=3;

    if(ui->checkBox_5->isChecked()) oper_kind=4;
